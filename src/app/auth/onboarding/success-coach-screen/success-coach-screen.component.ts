...
@Component({
  selector: "app-success-coach-screen",
  templateUrl: "./success-coach-screen.component.html",
  styleUrls: ["./success-coach-screen.component.scss"],
})
export class SuccessCoachScreenComponent implements OnInit {
  androidApp: any = "";
  iosApp: any = "";
